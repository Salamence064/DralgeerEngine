...
static inline void DEBUG_MESSAGE(std::string const &objectType, std::string const &name,
...
static inline int ERROR_MESSAGE(std::string const &objectType, std::string const &name,
...
static inline void INFO_MESSAGE(std::string const &objectType, std::string const &name,
        std::string const &description)
{
    std::cout << "[INFO] " << objectType << " " << name << ":\n\t" << description << "\n";
};

static inline void WARNING_MESSAGE(std::string const &objectType, std::string const &name,
